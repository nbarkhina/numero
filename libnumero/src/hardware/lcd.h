...
typedef struct LCDBase {
	...
	unsigned int x, y, z;							// LCD cursors
	unsigned int contrast;							// 0 to 39 or 31
...
typedef struct LCD {
	...
	unsigned int lcd_delay;				//delay in tstate required to write
	
	unsigned int last_read;				// Buffer previous read
